...
<div class="video-screen">
	<div class="large_player video responsive-container"
		...
		<iframe src="https://player.vimeo.com/video/164448459" frameborder="0"
		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane" id="transcript">
				...
				<div itemscope="" itemtype="http://schema.org/Article">
					...
					<!-- Scope END: Person -->
					<meta itemprop="url"
						content="https://corsetacademy.net/tutorial-3-hot-fix-rhinestones-working-with-an-ss16-tip/">
					<meta itemprop="mainEntityOfPage"
						content="https://corsetacademy.net/tutorial-3-hot-fix-rhinestones-working-with-an-ss16-tip/">
					<meta itemprop="datePublished" content="2016-04-28T07:10:20+00:00">
					<meta itemprop="dateModified" content="2016-04-28T07:10:20+00:00">
					<meta itemprop="copyrightYear" content="2016">
					<meta itemprop="inLanguage" content="en_US">
					<meta itemprop="name"
						content="Tutorial 3. Hot Fix Rhinestones. Working with an SS16 Tip.">
					<meta itemprop="headline"
						content="Tutorial 3. Hot Fix Rhinestones. Working with an SS16 Tip.">
					<meta itemprop="description"
						content="embellishing my wedding corset with ss16 rhinestones. The applicator is already hot enough and I press the first rhinestone onto the corset.">
					...
					<div itemprop="articleBody">
						<h1>Tutorial 3. Hot Fix Rhinestones. Working with an SS16 Tip.</h1>
						<p>
							<strong>I start embellishing my wedding corset with ss16
								rhinestones:</strong>
						</p>
						<p>
							<img class="img-responsive center-block"
								src="https://corsetacademy.s3.amazonaws.com/decoration/4/Tutorial%203_files/image002.jpg"
								alt="">
						</p>
						<p>
							The applicator is already hot enough and I <strong>press the
								first rhinestone onto the corset.</strong>
						</p>
						<p>
							<img class="img-responsive center-block"
								src="https://corsetacademy.s3.amazonaws.com/decoration/4/Tutorial%203_files/image004.jpg"
								alt="">
						</p>
						<p>
							Different rhinestones take different time to heat up. You can
							only figure it out through test and trial. As for me, I usually
							count to ten and then <strong>check if the rhinestone holds well
								enough or not yet.</strong>
						</p>
						<p>
							<img class="img-responsive center-block"
								src="https://corsetacademy.s3.amazonaws.com/decoration/4/Tutorial%203_files/image006.jpg"
								alt="">
						</p>
						<p>If it doesn't seem to hold well enough, I put the applicator
							back down and wait a little more until the rhinestone is firmly
							fused onto the fabric.</p>
						<p>Next, I apply an ss20 rhinestone. This time I count to fifteen.
							It takes longer to heat up larger rhinestones. I check how well
							the rhinestone has stuck.</p>
