...
<div id="list-content-mobile" class="hidden-md hidden-lg">
	<div id="content_mobile">
		...
		<ul id="courses" class="list-unstyled courses-menu courses_mobile">
			<li class="active"><a href="javascript:void(0)" class="nav-sub first"><i
				...
				<ul class="list-unstyled">
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/introduction_premium/">Premium Dress <span>(54)</span>
					</a></li>
				</ul></li>
			<li class="active"><a href="javascript:void(0)" class="nav-sub first"><i
					class="fa fa-my-menu"></i></a> <a class="second"
				href="#/categories/#1375">Wedding gowns <span>(10)</span>
			</a>
				<ul class="list-unstyled">
					<li><a href="javascript:void(0)" class="nav-sub first blank"
					...
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/how-to-make-wedding-dress/">Crew-Neck Dress
							with Full Skirt <span>(25)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="49"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/gown-with-the-bare-skin-effect/">Gown with
							Bare-Skin Effect <span>(31)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="50"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/introduction-gown/">Gown with Bare-Skin
					...
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/wedding-dress-without-side-seams-foreword/">Wedding
					...
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/classic-wedding-dress/">Wedding Dress with
							Lace Straps and Full Skirt <span>(42)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="122"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/sewing-crop-top-wedding-gown/">Crop Top
							Wedding Gown <span>(43)</span>
					</a></li>
				</ul></li>
			<li class="active"><a href="javascript:void(0)" class="nav-sub first"><i
					class="fa fa-my-menu"></i></a> <a class="second"
				href="#/categories/#5057">Wedding Skirts <span>(3)</span>
			</a>
				<ul class="list-unstyled">
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="124"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/why-an-elastic-waistband-skirt/">Princess
							Wedding Skirt <span>(13)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="125"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/why-a-mermaidfishtail-skirt/">Ruffle Fish
							Tail Wedding Skirt <span>(22)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="126"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/why-a-petite-skirt/">Mermaid Wedding Skirt
							<span>(26)</span>
					</a></li>
				</ul></li>
			<li class="active"><a href="javascript:void(0)" class="nav-sub first"><i
					class="fa fa-my-menu"></i></a> <a class="second"
				href="#/categories/#3343">Leather Corsets <span>(2)</span>
			</a>
				<ul class="list-unstyled">
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="93"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/sewing-steampunk-corset/">Steampunk Corset
							<span>(27)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="94"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/black-leather-corset-foreword/">Leather
							Corset <span>(22)</span>
					</a></li>
				</ul></li>
			<li class="active"><a href="javascript:void(0)" class="nav-sub first"><i
					class="fa fa-my-menu"></i></a> <a class="second"
				href="#/categories/#2294">Plus Sizes <span>(3)</span>
			</a>
				<ul class="list-unstyled">
					<li><a href="javascript:void(0)" class="nav-sub first blank"
					...
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/plus-size-dress-strap/">Plus-Size Dress
			...
			<li class="active"><a href="javascript:void(0)" class="nav-sub first"><i
					class="fa fa-my-menu"></i></a> <a class="second"
				href="#/categories/#624">Where to begin? <span>(7)</span>
			</a>
				<ul class="list-unstyled">
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="20"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/01-cutting-fabric-the-right-way/">ABC of
					...
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/push-up-pads/">Tips and Tricks <span>(6)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="33"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/opaque-corsets-review/">Sewing Techniques
							Reviews <span>(5)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="80"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/tutorial-1-cocktail-dress/">Cocktail Dress
							<span>(25)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="104"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/transparent-corset-in-3-hours/">Transparent
							Corset in 3 Hours <span>(1)</span>
					</a></li>
				</ul></li>
			<li class="active"><a href="javascript:void(0)" class="nav-sub first"><i
					class="fa fa-my-menu"></i></a> <a class="second"
				href="#/categories/#638">Opaque corsets <span>(5)</span>
			</a>
				<ul class="list-unstyled">
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="6"><i class="fa fa-my-menu"></i></a> <a class="second"
					...
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/tutorial-1-introductory-tutorial/">Bodysuit
							with Corset Cups <span>(9)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="24"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/tutorial-1-measurement/">Party Dress <span>(17)</span>
					</a></li>
				</ul></li>
			<li class="active"><a href="javascript:void(0)" class="nav-sub first"><i
					class="fa fa-my-menu"></i></a> <a class="second"
			...
			<li class="active"><a href="javascript:void(0)" class="nav-sub first"><i
				...
				<ul class="list-unstyled">
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/tutorial-1-decoration-materials/">Rhinestones
					...
					<li class="active"><a href="javascript:void(0)"
						...
						<ul class="list-unstyled">
							<li class="active"><a href="#/tutorial-1-glue-on-half-pearls/"
					...
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/tutorial-1-thick-decoration-element/">Thick
							Decoration Elements <span>(5)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="86"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/tutorial-1-decoration-materials-2/">Wedding
							Dress Decoration <span>(5)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="87"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/tutorial-1-types-of-sequins/">Sequins
					...
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/epaulettes-function-and-materials/">Epaulettes
							<span>(8)</span>
					</a></li>
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						data-catid="127"><i class="fa fa-my-menu"></i></a> <a
						class="second" href="#/tambour-or-luneville-embroidery-part-1/">Tambour
			...
			<li class="active"><a href="javascript:void(0)" class="nav-sub first"><i
				...
				<ul class="list-unstyled">
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/childrens-body-proportions/">The Law of
					...
					<li><a href="javascript:void(0)" class="nav-sub first blank"
						...
						class="second" href="#/tutorial-1-choosing-a-suitable-dress/">Fancy
